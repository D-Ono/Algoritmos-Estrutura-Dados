...
int dim, continua;
  do
   {
     continua = 0;
     printf("Insira o numero de componentes do array (>= 1 && <= 400000): ");
     scanf("%d",&dim);
...
// EXERCÍCIO:
//Elabore uma nova função Troca que utilize apenas 02 parâmetros
...
int main(){
  ...
  Associa_Valores_Array(vetor1,n2);
  //Imprimindo_Valores_Array(vetor2,n2);
  Ordenacao_Bolha2(vetor1,n2);
  printf("\n\n\n");
  //Imprimindo_Valores_Array(vetor2,n2);
  puts("\n\n\n");
  puts("\n\n\n");
